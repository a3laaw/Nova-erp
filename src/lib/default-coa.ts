...
const rawData: Omit<Account, 'id' | 'type' | 'statement' | 'balanceType'>[] = [
  // --- الأصول (1) ---
  { code: '1', name: 'الأصول', parentCode: null, isPayable: false, level: 0, description: '' },
  { code: '11', name: 'أصول متداولة', parentCode: '1', isPayable: false, level: 1, description: '' },
  { code: '1101', name: 'النقد وما يعادله', parentCode: '11', isPayable: false, level: 2, description: 'النقدية وما في حكمها (في الخزينة والعهد)' },
  { code: '110101', name: 'النقدية في الخزينة', parentCode: '1101', isPayable: true, level: 3, description: 'النقدية في الخزينة' },
  ...
  { code: '1104', name: 'مصروفات مقدمة', parentCode: '11', isPayable: false, level: 2, description: 'مصروف مدفوع مقدماً مثل التأمين وسلف الموظفين وإيجار المكتب' },
  { code: '110401', name: 'تأمين طبي مقدم', parentCode: '1104', isPayable: true, level: 3, description: 'تأمين طبي مدفوع مقدماً يتم إطفاء ما يخص السنة المالية إلى مصروف' },
  { code: '12', name: 'أصول غير متداولة', parentCode: '1', isPayable: false, level: 1, description: '' },
  { code: '121', name: 'الأصول الثابتة', parentCode: '12', isPayable: false, level: 2, description: '' },
  { code: '12101', name: 'الأصول الثابتة - المباني', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - المباني' },
  { code: '12102', name: 'الأصول الثابتة - المعدات', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - المعدات' },
  { code: '12103', name: 'الأصول الثابتة - الأجهزة المكتبية والطابعات', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - الأجهزة المكتبية والطابعات' },
  { code: '12104', name: 'الأصول الثابتة - الأثاث والتجهيزات', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - الأثاث والتجهيزات' },
  { code: '12105', name: 'الأصول الثابتة - السيارات', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - السيارات' },
  { code: '12106', name: 'الأصول الثابتة - الآلات', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - الآلات' },
  { code: '12107', name: 'الأصول الثابتة - أخرى', parentCode: '121', isPayable: false, level: 3, description: 'الأصول الثابتة - أخرى' },
  ...
  { code: '12201', name: 'إهلاك متراكم المباني', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم المباني' },
  { code: '12202', name: 'إهلاك متراكم المعدات', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم المعدات' },
  { code: '12203', name: 'إهلاك متراكم أجهزة مكتبية وطابعات', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم أجهزة مكتبية وطابعات' },
  { code: '12204', name: 'إهلاك متراكم الأثاث والتجهيزات', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم الأثاث والتجهيزات' },
  { code: '12205', name: 'إهلاك متراكم السيارات', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم السيارات' },
  { code: '12206', name: 'إهلاك متراكم الآلات', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم الآلات' },
  { code: '12207', name: 'إهلاك متراكم أخرى', parentCode: '122', isPayable: false, level: 3, description: 'إهلاك متراكم أخرى' },
  
  // --- الخصوم (2) ---
  { code: '2', name: 'الخصوم', parentCode: null, isPayable: false, level: 0, description: '' },
  { code: '21', name: 'الخصوم المتداولة', parentCode: '2', isPayable: false, level: 1, description: '' },
  ...
  // --- حقوق الملكية (3) ---
  { code: '3', name: 'حقوق الملكية', parentCode: null, isPayable: false, level: 0, description: '' },
  { code: '31', name: 'رأس المال', parentCode: '3', isPayable: false, level: 1, description: '' },
  { code: '3101', name: 'رأس المال المدفوع', parentCode: '31', isPayable: true, level: 2, description: '' },
  { code: '32', name: 'جاري الشركاء', parentCode: '3', isPayable: true, level: 1, description: 'حسابات الشركاء الشخصية مع الشركة' },
  { code: '33', name: 'أرباح مبقاة / خسائر مدورة', parentCode: '3', isPayable: true, level: 1, description: '' },

  // --- الإيرادات (4) ---
  { code: '4', name: 'الإيرادات', parentCode: null, isPayable: false, level: 0, description: '' },
  { code: '41', name: 'إيرادات النشاط التشغيلي', parentCode: '4', isPayable: false, level: 1, description: '' },
  ...
  // --- المصروفات (5) ---
  { code: '5', name: 'المصروفات', parentCode: null, isPayable: false, level: 0, description: '' },
  { code: '51', name: 'تكلفة الإيرادات', parentCode: '5', isPayable: false, level: 1, description: '' },
  ...
  { code: '52', name: 'مصاريف عمومية وإدارية', parentCode: '5', isPayable: false, level: 1, description: '' },
  ...
  { code: '521501', name: 'مصروف إهلاك المباني', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي للمباني' },
  { code: '521502', name: 'مصروف إهلاك المعدات', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي للمعدات' },
  { code: '521503', name: 'مصروف إهلاك الأجهزة', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي للأجهزة' },
  { code: '521504', name: 'مصروف إهلاك الأثاث', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي للأثاث' },
  { code: '521505', name: 'مصروف إهلاك السيارات', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي للسيارات' },
  { code: '521506', name: 'مصروف إهلاك الآلات', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي للآلات' },
  { code: '521507', name: 'مصروف إهلاك أخرى', parentCode: '5215', isPayable: false, level: 3, description: 'قسط الإهلاك السنوي لأصول أخرى' },
];
