...
const rawData: Omit<Account, 'id' | 'type' | 'statement' | 'balanceType'>[] = [
  ...
  { code: '11', name: 'أصول متداولة', parentCode: '1', isPayable: false, level: 1 },
  ...
  { code: '110201', name: 'حساب البنك الجاري', parentCode: '1102', isPayable: true, level: 3, description: 'حساب البنك الجاري' },
  { code: '1103', name: 'العملاء', parentCode: '11', isPayable: true, level: 2, description: 'مبالغ مستحقة على حساب العملاء (بالأجل)' },
  ...
  { code: '12', name: 'أصول غير متداولة', parentCode: '1', isPayable: false, level: 1 },
  { code: '121', name: 'الأصول الثابتة', parentCode: '12', isPayable: false, level: 2 },
  { code: '12101', name: 'الأصول الثابتة - المباني', parentCode: '121', isPayable: true, level: 3 },
  { code: '12102', name: 'الأصول الثابتة - المعدات', parentCode: '121', isPayable: true, level: 3 },
  { code: '12103', name: 'الأصول الثابتة - الأجهزة المكتبية والطابعات', parentCode: '121', isPayable: true, level: 3 },
  { code: '12104', name: 'الأصول الثابتة - الأثاث والتجهيزات', parentCode: '121', isPayable: true, level: 3 },
  { code: '12105', name: 'الأصول الثابتة - السيارات', parentCode: '121', isPayable: true, level: 3 },
  { code: '12106', name: 'الأصول الثابتة - الآلات', parentCode: '121', isPayable: true, level: 3 },
  { code: '12107', name: 'الأصول الثابتة - أخرى', parentCode: '121', isPayable: true, level: 3 },
  { code: '122', name: 'إهلاك الأصول الثابتة المتراكم', parentCode: '12', isPayable: false, level: 2 },
  { code: '12201', name: 'إهلاك متراكم المباني', parentCode: '122', isPayable: true, level: 3 },
  { code: '12202', name: 'إهلاك متراكم المعدات', parentCode: '122', isPayable: true, level: 3 },
  { code: '12203', name: 'إهلاك متراكم أجهزة مكتبية وطابعات', parentCode: '122', isPayable: true, level: 3 },
  { code: '12204', name: 'إهلاك متراكم الأثاث والتجهيزات', parentCode: '122', isPayable: true, level: 3 },
  { code: '12205', name: 'إهلاك متراكم السيارات', parentCode: '122', isPayable: true, level: 3 },
  { code: '12206', name: 'إهلاك متراكم الآلات', parentCode: '122', isPayable: true, level: 3 },
  { code: '12207', name: 'إهلاك متراكم أخرى', parentCode: '122', isPayable: true, level: 3 },
  ...
  { code: '210401', name: 'رواتب مستحقة', parentCode: '2104', isPayable: true, level: 3 },
  { code: '210402', name: 'إيجار مستحق', parentCode: '2104', isPayable: true, level: 3 },
  { code: '2105', name: 'تأمينات اجتماعية مستحقة', parentCode: '21', isPayable: true, level: 2 },
  { code: '2106', name: 'مخصص مكافأة نهاية الخدمة', parentCode: '21', isPayable: true, level: 2 },
  { code: '2107', name: 'ضريبة القيمة المضافة', parentCode: '21', isPayable: true, level: 2 },
  ...
  { code: '3101', name: 'رأس مال المالك', parentCode: '31', isPayable: true, level: 2 },
