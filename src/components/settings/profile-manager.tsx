...
import { Loader2, Save, ImageIcon, User, Briefcase, Sparkles, CloudUpload, Link2, X } from 'lucide-react';
...
export function ProfileManager() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Force local token refresh to update claims/metadata if needed
            await refreshToken();
            
            toast({ title: '✅ تم تحديث الملف بنجاح', description: 'سيتم ظهور بياناتك الجديدة في كافة أرجاء النظام.' });
            setProfileFile(null);
            setPreview(null);
            ...
            console.error(error);
            toast({ variant: 'destructive', title: 'خطأ في الحفظ', description: 'فشل تحديث بيانات الملف الشخصي.' });
        } finally {
            setIsSaving(false);
        }
    };
            ...
            <Card className="rounded-[3rem] border-none shadow-2xl overflow-hidden bg-white/70 backdrop-blur-xl">
                <CardHeader className="p-10 pb-8 bg-gradient-to-r from-[#FFB000] to-[#FF7A00] text-white">
                    <div className="flex items-center gap-6">
                        <div className="relative group">
                            <div className="w-32 h-32 rounded-[2.5rem] border-4 border-white/40 shadow-2xl overflow-hidden bg-white/20 flex items-center justify-center transition-transform hover:scale-105 duration-500">
                            ...
                            <button 
                                ...
                                className="absolute -bottom-2 -left-2 p-2.5 bg-white text-primary rounded-2xl shadow-xl border-2 border-primary/10 hover:scale-110 transition-transform active:scale-95"
                            >
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="relative group">
                                ...
                                <Input 
                                    ...
                                    className="h-12 rounded-2xl border-2 bg-slate-50 shadow-inner pr-12 font-black text-lg"
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="relative group">
                                ...
                                <Input 
                                    ...
                                    className="h-12 rounded-2xl border-2 bg-slate-50 shadow-inner pr-12 font-bold"
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-4 bg-primary/5 rounded-[2rem] border-2 border-dashed border-primary/10 shadow-inner">
                            <Textarea 
                                ...
                                placeholder="اكتب هنا عن سنوات خبرتك، المشاريع التي أشرفت عليها، أو التخصصات الدقيقة التي تتقنها..."
                                rows={8}
                ...
                <CardFooter className="p-10 border-t bg-muted/10 flex justify-end">
                    ...
                    >
                        ...
                        {isSaving ? 'جاري ترحيل التعديلات...' : 'حفظ الملف الشخصي'}
                    </Button>
                </CardFooter>
            </Card>
        </div>
