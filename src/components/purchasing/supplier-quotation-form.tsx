    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            أدخل بيانات الأسعار والشروط من مستند المورد الرسمي.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="py-4 space-y-6">
              ...
              <div className="flex items-end gap-4">
                <div className="grid gap-2 flex-grow">
                  <Label className="text-xs font-bold text-muted-foreground">
                    رفع مستند المورد (PDF)
                  </Label>
                  <Input
                    type="file"
                    accept="application/pdf"
                    onChange={handleFileChange}
                    className="bg-background rounded-xl border-primary/10 h-11"
                  />
                </div>
                <Button
                  type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 border rounded-2xl bg-muted/30">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="مثال: QT-10203"
                  className="rounded-xl h-11"
                />
              </div>
              <div className="grid gap-2">
                <Label className="font-bold">
                  تاريخ العرض <span className="text-destructive">*</span>
                </Label>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <Label className="text-lg font-black text-primary">
                  قائمة الأسعار للأصناف المطلوبة
                </Label>
              ...
              <div className="space-y-3">
                {rfq.items.map((rfqItem) => {
                  ...
                  return (
                    <div
                      key={rfqItem.id}
                      className="grid grid-cols-12 gap-4 items-center p-4 bg-background border-2 border-transparent hover:border-primary/20 rounded-2xl shadow-sm transition-all group"
                    >
                      <div className="col-span-6 flex flex-col gap-1">
                        <Label className="font-black group-hover:text-primary transition-colors">
                          {rfqItem.itemName}
                        </Label>
        ...
        <DialogFooter className="p-6 border-t bg-muted/10">
          <Button variant="outline" onClick={onClose} disabled={isSaving} className="h-12 px-8 rounded-xl font-bold">
            إلغاء
          </Button>
          <Button
