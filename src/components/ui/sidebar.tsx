...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-r-2 border-primary/10 px-2.5 py-0.5 ml-0 mr-4 pr-4 pl-0 bg-secondary/30 rounded-l-xl",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
...
>(({ size = "md", isActive, className, ...props }, ref) => {
  return (
    <Button
      ...
      data-active={isActive}
      className={cn(
        "flex h-auto min-w-0 w-full justify-start -translate-x-px items-center gap-3 overflow-hidden rounded-lg py-4 px-6 outline-none ring-sidebar-ring transition-all duration-300 bg-primary text-white hover:bg-white hover:text-primary disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-8 [&>svg]:shrink-0",
