  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-black text-[#1e1b4b]",
        caption_dropdowns: "flex justify-center gap-1 items-center",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 rounded-lg border-2"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-black text-[0.7rem] uppercase",
        ...
        day_today: "bg-muted text-accent-foreground font-black",
        day_outside:
        ...
        // تنسيقات القوائم المنسدلة للسنة والشهر
        dropdown: "rdp-dropdown bg-white border-2 border-slate-100 rounded-lg text-xs font-black p-1 focus:border-primary outline-none",
        dropdown_month: "mr-1",
        dropdown_year: "ml-1",
        ...classNames,
      }}
