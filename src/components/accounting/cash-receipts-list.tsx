    ...
    return (
        div className="border rounded-lg">
            Table>
                TableHeader>
                    TableRow>
                        TableHead>رقم السندTableHead>
                        TableHead>اسم العميلTableHead>
                        TableHead>التاريخTableHead>
                        TableHead>طريقة الدفعTableHead>
                        TableHead className="text-left">المبلغTableHead>
                    ...
                    TableRow>
                        TableCell colSpan={6}>
                            div className="p-8 text-center border-2 border-dashed rounded-lg">
                                ...
                                h3 className="mt-4 text-lg font-medium">لا توجد سندات قبضh3>
