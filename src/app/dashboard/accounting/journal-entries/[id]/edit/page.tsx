...
export default function EditJournalEntryPage() {
  ...
  if (entryLoading || refDataLoading) {
    return Card className="max-w-4xl mx-auto" dir="rtl">CardHeader>Skeleton className="h-8 w-48" />CardHeader>CardContent>Skeleton className="h-64 w-full" />CardContent>
  }
  
  if (!entry) {
    return Card dir="rtl">CardHeader>CardTitle>خطأCardTitle>CardHeader>CardContent>p>لم يتم العثور على قيد اليومية المطلوب.p>CardContent>Card>
  }
        ...
        form onSubmit={handleSubmit(onSubmit)}>
            CardHeader>
                div className="flex justify-between items-start">
                    div>
                        CardTitle>تعديل قيد اليوميةCardTitle>
