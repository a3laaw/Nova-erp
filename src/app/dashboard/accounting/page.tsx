...
export default function AccountingDashboardPage() {
    ...
    return (
        <div className="space-y-10" dir="rtl">
            <Card className="border-none rounded-[2.5rem] overflow-hidden bg-gradient-to-l from-white to-indigo-50 shadow-sm">
                <CardHeader className="pb-8 px-10">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                        <div className="space-y-1 text-center lg:text-right">
                            ...
                            <CardDescription className="text-base font-bold text-slate-500 mt-1 pr-16">إدارة السيولة، القوائم المالية، والتحليلات الربحية للمشاريع.</CardDescription>
                        </div>
                        <div className="flex items-center gap-3">
                            <Button asChild className="h-11 px-10 rounded-xl font-black gap-2 shadow-lg shadow-primary/20">
                                <Link href="/dashboard/accounting/journal-entries/new"><PlusCircle className="h-5 w-5" /> إضافة قيد</Link>
                            </Button>
                        </div>
                    </div>
                </CardHeader>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="overflow-hidden border-none rounded-[2rem] bg-primary text-primary-foreground shadow-xl">
                    ...
                    <CardContent className="px-6 pb-6">
                        ...
                        <Link href="/dashboard/accounting/journal-entries" className="text-[10px] font-bold underline mt-4 flex items-center gap-1 hover:text-white/100 transition-colors">مراجعة وترحيل الآن <ArrowRight className="h-2 w-2"/></Link>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
                <Card className="rounded-[2.5rem] border-none shadow-2xl bg-white/95 overflow-hidden">
                    ...
                    <CardContent className="grid grid-cols-2 gap-4 p-8">
                        ...
                        <QuickLink href="/dashboard/accounting/income-statement" label="قائمة الدخل (P&L)" icon={<TrendingUp className="h-4 w-4"/>} />
                        <QuickLink href="/dashboard/accounting/balance-sheet" label="المركز المالي" icon={<Landmark className="h-4 w-4"/>} />
                        <QuickLink href="/dashboard/accounting/cash-flow" label="التدفقات النقدية" icon={<Waves className="h-4 w-4"/>} />
                    </CardContent>
                </Card>
