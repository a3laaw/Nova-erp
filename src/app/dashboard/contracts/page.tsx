    ...
    <div className="min-h-full -m-8 p-8 bg-[#F8F9FE]" dir="rtl">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="relative rounded-[2rem] border-none shadow-xl bg-gradient-to-br from-[#2E5BCC] to-[#1c46a8] text-white overflow-hidden group hover:scale-[1.02] transition-transform">
            ...
            <Card className="relative rounded-[2rem] border-none shadow-xl bg-gradient-to-br from-[#14453D] to-[#0d2e29] text-white overflow-hidden group hover:scale-[1.02] transition-transform">
                <CardHeader className="relative z-10">
                    <div className="flex justify-between items-start">
                ...
                <CardFooter className="relative z-10 pt-0 pb-8">
                    <Button asChild className="w-full h-12 bg-white text-[#14453D] hover:bg-emerald-50 font-black text-lg rounded-xl gap-2 shadow-lg">
          ...
          <CardContent className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 bg-muted/30 p-6 rounded-3xl border-2 border-dashed">
                  <div className="grid gap-2">
                      <Label className="font-bold flex items-center gap-2 text-gray-700"><User className="h-3.5 w-3.5 text-primary"/> اسم العميل</Label>
                      <Input 
                  ...
                  <div className="grid gap-2">
                      <Label className="font-bold flex items-center gap-2 text-gray-700"><Phone className="h-3.5 w-3.5 text-primary"/> رقم الهاتف</Label>
                      <Input 
                  ...
                  <div className="grid gap-2">
                      <Label className="font-bold flex items-center gap-2 text-gray-700"># رقم العقد</Label>
                      <Input 
                  ...
                  <div className="grid gap-2 lg:col-span-2">
                      <Label className="font-bold flex items-center gap-2 text-gray-700"><Calendar className="h-3.5 w-3.5 text-primary"/> نطاق تاريخ العقد</Label>
