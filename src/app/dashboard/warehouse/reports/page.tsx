...
import { Package, History, BarChart3, TrendingDown, TrendingUp, DollarSign, ShieldCheck, AlertTriangle } from 'lucide-react';
...
export default function InventoryReportsPage() {
  return (
    <Card dir="rtl">
        <CardHeader>
            <CardTitle>تقارير المخزون والرقابة</CardTitle>
            <CardDescription>اختر التقرير المطلوب لعرض تحليلات مفصلة عن المخزون والكفالات والتكاليف.</CardDescription>
        </CardHeader>
            ...
            {reportList.map((report) => {
                ...
                return (
                    <Link href={report.href} key={report.href} className="group block">
                        <Card className="h-full hover:shadow-lg transition-shadow border-2 border-transparent hover:border-primary/10">
                            <CardHeader>
