                ...
                <CardHeader className="pb-8 px-8 border-b">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <CardTitle className="text-2xl font-black">أذونات استلام البضاعة (GRN)</CardTitle>
                                <CardDescription className="text-base font-medium">إثبات وصول المواد للمخازن وتغذية الأرصدة فعلياً ومحاسبياً.</CardDescription>
                            </div>
                        </div>
                        <Button asChild className="h-11 px-6 rounded-xl font-black gap-2 shadow-lg shadow-green-100">
