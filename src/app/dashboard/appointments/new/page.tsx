    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const architecturalEngineers = allEmployees.filter(emp => emp.department === 'القسم المعماري' && (emp.jobTitle?.includes('مهندس') || emp.jobTitle?.toLowerCase().includes('engineer')));
