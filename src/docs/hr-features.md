...
*   **الاستئذانات:**
    ...
    *   **الوصف:** يمكن للموظفين تقديم طلبات استئذان (للتأخير الصباحي أو الخروج المبكر). يمر الطلب بدورة موافقات ويخضع لقيود ذكية (مثل عدم السماح بأكثر من استئذان في نفس اليوم أو تجاوز الحد الشهري).
    *   **التكامل مع الرواتب:** عند الموافقة على طلب استئذان، يقوم نظام الرواتب **تلقائيًا** بتجاهل أي خصم تأخير متعلق بهذا اليوم عند معالجة كشف الراتب.
