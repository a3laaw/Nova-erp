...
لوحة معلومات ذكية لمراقبة أداء العمل واتخاذ قرارات مستنيرة.

*   **تقارير سير العمل:** عرض فوري للمهام المتأخرة، المراحل الخاملة، والعملاء المحتملين (سواء لم يحضروا أو توقفوا بعد الاستفسارات)، وفرص البيع الإضافي للعملاء الحاليين.

> 🔗 **للتفاصيل الكاملة عن منطق التقارير، راجع [ملف منطق التقارير](reports-logic.md).**

---

### 6. مميزات على مستوى النظام
